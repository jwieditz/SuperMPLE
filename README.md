...
| ![PL example pattern](https://github.com/jwieditz/SuperMPLE/blob/main/mple-example-pattern.png) | ![PL example pattern](https://github.com/jwieditz/SuperMPLE/blob/main/mple-example-pl.png) |
| :----------------------------------------------------------: | ------------------------------------------------------------ |
